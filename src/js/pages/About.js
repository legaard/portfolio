        ...
        <div className="row">
          <div className="col-md-8">
            <p>
              ...
              My name is Lasse Legaard and I am a Danish IT product developer specialized in software development and interaction design. As you might already have experienced (in the <Link to="/projects">projects</Link> section), I am a fairly versatile guy who can create almost anything from simple mock-ups to more sophisticated and functional products. I have a great interest in IoT devices and concept development, and I always work on small projects in my spare time, e.g. building a NAS-server using a Raspberry Pi or making a physical Pomodoro timer from an Particle Photon and a NeoPixel ring. When I am not exercising my tech muscles I spend time with family and friends, and sometimes I even find time to do physial workouts.
            </p>
            <p>
              I hold a BSc degree in IT from Aarhus University (AU) and currently pursuing a MSc degree in IT Product Development from the same university. During my last year as a master student – which is this year – I went abroad to study at the Industrial Design department at Eindhoven University of Technology (TU/e). My stay there broadened my perspective on visual and functional aesthetics and I acquired some new design modelling techniques as well.
            </p>
            <p>
          ...
          <div className="col-md-4">
            <img id="profile-image" src="assets/img/profile.jpg"/>
            <h3>Skills</h3>
